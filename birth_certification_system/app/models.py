...
class DossierNaissance(db.Model):
    ...
    numero_mere = db.Column(db.String(100), nullable = True)
    email_mere = db.Column(db.String(100), nullable = True)
    ...
    numero_pere = db.Column(db.String(100), nullable = True)
    email_pere = db.Column(db.String(100), nullable = True)
